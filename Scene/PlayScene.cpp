...
int ScoreboardScene::myscores = 0;
	...
	for (int i = 0; i < SpeedMult; i++) {
		...
		if (enemyWaveData.empty()) {
			if (EnemyGroup->GetObjects().empty()) {
				...
				delete imgTarget;*/
				// Change to Win Scene.
				ScoreboardScene::myscores = money;
		...
		case 3:
			...
			break;
			case 4: // Assuming 4 is the ID for the new enemy type
				EnemyGroup->AddNewObject(enemy = new BigEnemy(SpawnCoordinate.x, SpawnCoordinate.y)); // Replace CustomEnemy with your custom enemy class
			break;
...
void PlayScene::ConstructUI() {
	...
	UIGroup->AddNewControlObject(btn);
	// Button for Custom Turret
	TurretButton* btnCustomTurret;


	// Button for Custom Turret
	btn = new TurretButton("play/floor.png", "play/dirt.png",
	  Engine::Sprite("play/tower-base.png", 1522, 136, 0, 0, 0, 0),
	  Engine::Sprite("play/turret-7.png", 1522, 136 - 8, 0, 0, 0, 0)
